          ...
          <div class="ht-right">
            ...
            @endif
              <div class="top-social">
                  <a href="https://www.facebook.com/naim.islam.399"><i class="ti-facebook"></i></a>
                  <a href="https://twitter.com/nayeem8662_khan"><i class="ti-twitter-alt"></i></a>
                  <a href="https://www.linkedin.com/in/md-faizur-rahman-khan-3a75a0130/"><i class="ti-linkedin"></i></a>
  ...
  <div class="container">
      <div class="inner-header">
          <div class="row">
              ...
              <form class="example" method="GET" action="{{url('/search')}}"enctype="multipart/form-data" >
                @csrf
                    <input type="text" placeholder="Product Search" name="Name"style="margin-top:5px;width:90%">
